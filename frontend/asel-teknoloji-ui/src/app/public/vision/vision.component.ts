  ...
  template: `
    ...
    <div class="bg-blue-900 text-white py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <nav class="flex items-center gap-2 text-blue-300 text-sm mb-6">
          ...
          <span>/</span>
          <span class="text-white font-medium">Vizyon</span>
        </nav>
        <h1 class="text-4xl md:text-5xl font-extrabold mb-4">
          {{ page?.title || 'Vizyonumuz' }}
        </h1>
        @if (page?.subtitle) {
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        @if (loading) {
          ...
          <div class="text-center py-20 text-gray-400">
            ...
            <p class="text-lg">Vizyon içeriği henüz eklenmemiş.</p>
          </div>
        } @else {
    ...
    <section class="py-16 bg-blue-900 text-white text-center">
      <div class="max-w-2xl mx-auto px-4">
        <h2 class="text-3xl font-extrabold mb-4">Misyonumuzu da İnceleyin</h2>
        <p class="text-blue-200 mb-8">Değerlerimiz ve hedeflerimiz hakkında daha fazla bilgi edinin.</p>
        <a routerLink="/misyon"
