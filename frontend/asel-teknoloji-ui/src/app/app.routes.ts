...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'is-ortaklarimiz', loadComponent: () => import('./public/business-partners/business-partners.component').then(m => m.BusinessPartnersComponent) },
...

  {
    ...
    children: [
      ...
      { path: 'business-partners', loadComponent: () => import('./admin/business-partners/business-partners.component').then(m => m.BusinessPartnersComponent), data: { roles: ['SuperAdmin', 'Admin'] } },
